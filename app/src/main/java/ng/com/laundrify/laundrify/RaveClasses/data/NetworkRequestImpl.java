...
public class NetworkRequestImpl implements DataRequest.NetworkRequest {
    ...
    public void requeryTxv2(RequeryRequestBodyv2 requeryRequestBody, final Callbacks.OnRequeryRequestv2Complete callback) {
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                Log.i("test" , "2nd Verified it " + jsonResponse);
            }
    ...
    @Override
    public void chargeToken(TokenChargeBody body, final Callbacks.OnChargeRequestComplete callback) {

        createService();

        Call<String> call = service.chargeToken(body);
